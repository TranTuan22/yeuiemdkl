...
const messages = [
    "Helo iemmmmmm",
    "Không bít hôm nay em có chiện gì muốn kể cho tui hông nhỉ...",
    "2 hôm nay thời gian mà a ngắm iem còn không bằng 1 buổi tối nữa huhuhu",
    "Anh có làm gì làm em bùn thì cho a xin lũi nheeeee <3",
    "Nếu có gì mệt mỏi thì nhớ phải kể cho tui, chứ hong được im lặng nghe ch",
    "Chúc iem 8/3 vui vẻeee",
    "Chúc xik gái thì hơi thừa roài nên chúc eim thật may mắn trong những dự định sắp tới",
    "Eo Eo hay HSK cũng phải đạt aim nhaaa",
    "Anh yêu em",
    "pipi ak"
];
